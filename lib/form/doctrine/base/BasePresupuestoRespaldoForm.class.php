...
/**
 * PresupuestoRespaldo form base class.
 *
 * @method PresupuestoRespaldo getObject() Returns the current form's model object
 *
 * @package    sigpro
 * @subpackage form
 ...
 */
abstract class BasePresupuestoRespaldoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id_presupuesto'     => new sfWidgetFormInputHidden(),
      'id_proyecto'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ProyectoRespaldo'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'id_proyecto'        => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ProyectoRespaldo'))),
    ...
    $this->widgetSchema->setNameFormat('presupuesto_respaldo[%s]');
