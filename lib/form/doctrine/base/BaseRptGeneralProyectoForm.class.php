...
abstract class BaseRptGeneralProyectoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ing_reales'       => new sfValidatorNumber(array('required' => false)),
      'gas_reales'       => new sfValidatorNumber(array('required' => false)),
      'compromisos'      => new sfValidatorNumber(array('required' => false)),
      'ing_reales_us'    => new sfValidatorNumber(array('required' => false)),
      'gas_reales_us'    => new sfValidatorNumber(array('required' => false)),
      'compromisos_us'   => new sfValidatorNumber(array('required' => false)),
