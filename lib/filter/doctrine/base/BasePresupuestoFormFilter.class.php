...
abstract class BasePresupuestoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tiene_overhead'     => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'tiene_overhead'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
