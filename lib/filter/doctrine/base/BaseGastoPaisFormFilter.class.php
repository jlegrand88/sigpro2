...
/**
 * GastoPais filter form base class.
 *
 * @package    sigpro
 * @subpackage filter
 ...
 */
abstract class BaseGastoPaisFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'id_archivo_gasto_pais' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ArchivoGastoPais'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'id_archivo_gasto_pais' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ArchivoGastoPais'), 'column' => 'id_archivo_gasto_pais')),
  ...
  {
    return array(
      'id_gasto_pais'         => 'Number',
      'id_proyecto'           => 'ForeignKey',
      'id_tipo_movimiento'    => 'ForeignKey',
      'id_archivo_gasto_pais' => 'ForeignKey',
      'cuenta'                => 'Text',
      'nombre_cuenta'         => 'Text',
      'periodo'               => 'Text',
      'enero'                 => 'Number',
