...
abstract class BaseRptGeneralProyectoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ing_reales'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'gas_reales'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'compromisos'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'ing_reales_us'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'gas_reales_us'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'compromisos_us'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
