...
<div class="tab-content col-lg-12">
    <?php
        ...
        include_partial('proyecto/fichaProyecto',array('form' => $form, 'permiso' => $permiso, 'permisosUsuario' => $permisosUsuario, 'editable' => $editable, 'alerta' => $varAlerta, 'alertaSuccess' => $varAlertaSuccess,'archivosContrato' => $archivosContrato, 'idUsuario' => $idUsuario));
